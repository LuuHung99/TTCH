...
function Home() {
    ...
    const carouselData = [
      ...
      },
      {
        ...
        description: "carousel description",
        image:
          "http://amigosthemes.com/frutella/frutella-black/assets/images/content/x/fruits-plate.png",
      },
      {
        title: "carousel title 3",
        description: "carousel description",
        image:
          "http://amigosthemes.com/frutella/frutella-black/assets/images/content/x/plate.png",
      },
    ];
